...
export function Signup() {
    ...
    return <div className="relative h-screen w-screen flex justify-center items-center overflow-hidden bg-gradient-to-br from-purple-200 to-gray-200">
        ...
        <div className="bg-white rounded-xl border min-w-48 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
            <Input reference={usernameRef} placeholder="Username" />
            <Input reference={passwordRef} placeholder="Password" />
            <div className="flex justify-center pt-4">
                <Button onClick={signup} fullW={true} loading={false} variant="primary" text="Signup" />
            </div>
        </div>
    </div>
}
